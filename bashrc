...
case "$(hostname)" in
    gravity)
        ...
        ;;
    *)
        export VTROOT=/home/vr/apps/VirtuTrace/local
        ;;
esac

export VJ_CFG_PATH=$VTROOT/share/vrjuggler-3.0/data/configFiles
export VJ_BASE_DIR=$VTROOT
export VPR_DEBUG_ENABLE=1
export VPR_DEBUG_NFY_LEVEL=99
export LD_LIBRARY_PATH=$HOME/local/lib:$VTROOT/lib:/usr/lib:/usr/local/lib:/usr/lib64:/usr/local/lib64
